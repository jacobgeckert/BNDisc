...
import { checkAdminAccess } from './loginAdmin.js?v=147';
import { checkLeagueAccess } from './loginLeague.js?v=147';
import { loadCurrentEvents } from './currentEvents.js?v=147'; 
import { initAdminForm } from './admin.js?v=156'; // Ensure this is imported

...
export async function checkLeagueAccess(currentUser = null) {
    ...
    try {
        ...
        const directorHeader = document.getElementById('league-director-header');
        ...
        if (directorHeader) directorHeader.style.display = '';
        ...
        if (user) {
            ...
            if (authorized.isAdmin) {
                ...
                if (directorHeader) directorHeader.style.display = 'none';
